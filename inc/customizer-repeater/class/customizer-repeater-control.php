...
class Customizer_Repeater extends WP_Customize_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		...
		if ( file_exists( WP_BOTTOM_MENU_DIR_PATH . 'inc/customizer-repeater/inc/icons.php' ) ) {
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'customizer-repeater-admin-stylesheet', WP_BOTTOM_MENU_DIR_URL . 'inc/customizer-repeater/css/admin-style.css', array(), CUSTOMIZER_REPEATER_VERSION );

		wp_enqueue_style( 'wp-color-picker' );

		wp_enqueue_script( 'customizer-repeater-script', WP_BOTTOM_MENU_DIR_URL . 'inc/customizer-repeater/js/customizer_repeater.js', array('jquery', 'jquery-ui-draggable', 'wp-color-picker' ), CUSTOMIZER_REPEATER_VERSION, true  );
